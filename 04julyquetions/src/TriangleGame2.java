	...
	public class TriangleGame2 {
		static void game(int a,int b,int c) //put static before void to call the method without creating an object such as d here//
		{
	      int sum=a+b+c;
	      if(sum==180) {
	     if(a==b&&b==c&&c==a){
		...
		public static void main(String[] args) {
			...
			// without making an object of class TriangleGame we can call the method //
			game(num1,num2,num3);//d.game(a,b,c)
